...
<body>
  <header><div class="menu_side">
      <h6 id="menu_list_active_button"><i class="bi bi-music-note-list"></i>
</h6>
  <div class="playlist">
    ...
    <div class="song_side">
      <nav>
       ...
       <div class="content">
          <h1>Badshah</h1>
          <p>Aditya Prateek Singh Sisodia,, known by his stage name Badshah, is an Indian rapper, singer, film <br>
            producer and businessman known for his Hindi, Haryanvi, and Punjabi music. He started his career<br>
            in 2006 alongside Yo Yo Honey Singh in his Hip Hop group Mafia Mundeer. He split from Honey <br>
            in 2012 and released his independent Haryanvi song Kar Gayi Chull. He is also considered one of the <br>
            highest-paid artists and also a controversial rapper of India, for his songs like Genda Phool and Pagal.  
        ...
        <div class="popular_song">
            ...
            <div class="pop_song">
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/Badshah/1.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="1"></i>
                  </div>
                  <h5>On My Way
                    <br>
                ...
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/Badshah/2.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="2"></i>
                  </div>
                  <h5>On My Way
                    <br>
