  ...
  <header>
    ...
    <div class="song_side">
      <nav>
       ...
       <div class="content">
          <h1>Avicii</h1>
          <p>Avicii was a Swedish DJ, remixer and music producer whose real name was Tim Bergling.<br> 
            He began posting his remixes on electronic music forums at the age of 16, which led to<br> 
            his first record deal. He was known for his hits such as "Levels", "Wake Me Up" and <br>
            "Hey Brother". 
          </p>
             <div class="buttons">
        ...
        <div class="popular_song">
            ...
            <div class="pop_song">
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/avicii/1.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="1"></i>
                  </div>
                  <h5>On My Way
                    <br>
                ...
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/avicii/2.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="2"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/avicii/3.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/avicii/4.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="4"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/avicii/5.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="5"></i>
                  </div>
                  <h5>On My Way
                    <br>
