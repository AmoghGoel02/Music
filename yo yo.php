    ...
    <div class="song_side">
      <nav>
       ...
       <div class="content">
          ...
          <p>Hirdesh Singh (born 15 March 1983), known professionally as Yo Yo Honey Singh or simply Honey Singh, is 
            an Indian music producer, rapper, singer, songwriter and an actor. He started in 2003 as a session and 
            recording artist, and became a bhangra and hip hop music producer. Later, he became successful with his 
            songs and started making songs for Bollywood films.
        ...
        <div class="popular_song">
            ...
            <div class="pop_song">
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/Yo Yo Honey Singh/1.jpg" alt="Yo Yo Honey Singh" >
                      <i class="bi playListPlay bi-play-circle-fill" id="1"></i>
                  </div>
                  <h5>On My Way
                    <br>
                ...
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/Yo Yo Honey Singh/2.jpg" alt="Yo Yo Honey Singh" >
                      <i class="bi playListPlay bi-play-circle-fill" id="2"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Yo Yo Honey Singh/3.jpg" alt="Yo Yo Honey Singh" >
                      <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Yo Yo Honey Singh/4.jpg" alt="Yo Yo Honey Singh" >
                      <i class="bi playListPlay bi-play-circle-fill" id="4"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Yo Yo Honey Singh/5.jpg" alt="Yo Yo Honey Singh" >
                      <i class="bi playListPlay bi-play-circle-fill" id="5"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Yo Yo Honey Singh/6.jpg" alt="Yo Yo Honey Singh" >
                      <i class="bi playListPlay bi-play-circle-fill" id="6"></i>
                  </div>
                  <h5>On My Way
                    <br>
