const music = new Audio('Songs/Diljit/1.mp3');
//music.play();
const songs = [
    {
       id:'1',
       songName:`Chauffeur <br>
    ...
    {
        id:'5',
        songName:`Ikk Kudi(Reprised Version) <br>
        <div class="subtitle">Diljit Dosanjh</div>`,
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((element)=>{
    element.addEventListener('click',(e)=>{
       index= e.target.id;
       music.src=`Songs/Diljit/${index}.mp3`;
       poster_master_play.src=`img/Diljit/${index}.jpg`;
       music.play();
       MasterPlay.classList.remove('bi-play-fill');
       MasterPlay.classList.add('bi-pause-fill');
       download_music.href = `Songs/Diljit/${index}.mp3`;
