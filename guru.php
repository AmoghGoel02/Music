  ...
  <header>
    ...
    <div class="song_side">
      <nav>
       ...
       <div class="content">
          <h1>Guru Randhawa</h1>
          <p>Gursharanjot Singh Randhawa is an Indian singer, songwriter and music composer associated<br> 
            with Punjabi, Bhangra, Indi-pop and Bollywood music. He is known for songs like<br>
            "Lahore", "Ishare Tere", "Slowly Slowly", and "Tere Te". Guru Randhawa's debut <br>
            single was "Same Girl" in collaboration with Arjun.
          </p>
             <div class="buttons">
        ...
        <div class="popular_song">
            ...
            <div class="pop_song">
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/Guru Randhawa/1.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="1"></i>
                  </div>
                  <h5>On My Way
                    <br>
                ...
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/Guru Randhawa/2.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="2"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Guru Randhawa/3.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Guru Randhawa/4.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="4"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Guru Randhawa/5.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="5"></i>
                  </div>
                  <h5>On My Way
                    <br>
