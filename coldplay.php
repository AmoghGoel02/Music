  ...
  <header>
    ...
    <div class="song_side">
      <nav>
       ...
       <div class="content">
          <h1>Coldplay</h1>
          <p>Coldplay is a British rock band formed in London in 1997. The band consists of vocalist and pianist 
            Chris Martin, guitarist Jonny Buckland, bassist Guy Berryman, drummer Will Champion and creative director 
            Phil Harvey. They have released nine studio albums and sold over 100 million records worldwide. Their 
            latest album "Music of the Spheres" was released on October 15, 2021.
        ...
        <div class="popular_song">
            ...
            <div class="pop_song">
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/Coldplay/1.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="1"></i>
                  </div>
                  <h5>On My Way
                    <br>
                ...
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/Coldplay/2.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="2"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Coldplay/3.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                  </div>
                  <h5>On My Way
                    <br>
