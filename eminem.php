  ...
  <header>
    ...
    <div class="song_side">
      <nav>
       ...
       <div class="content">
          <h1>Eminem</h1>
          <p>Marshall Bruce Mathers III, known professionally as Eminem, is an American rapper, songwriter, and 
            record producer. He is credited with popularizing hip hop in middle America and is critically acclaimed 
            as one of the greatest rappers of all time. Eminem's global success and acclaimed works are widely 
            regarded as having broken racial barriers for the acceptance of white rappers in popular music.
        ...
        <div class="popular_song">
            ...
            <div class="pop_song">
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/Eminem/1.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="1"></i>
                  </div>
                  <h5>On My Way
                    <br>
                ...
                <li class="songItem">
                  <div class="img_play">
                      <img src="img/Eminem/2.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="2"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Eminem/3.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Eminem/4.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="4"></i>
                  </div>
                  <h5>On My Way
                    <br>
                  ...
                  <div class="img_play">
                      <img src="img/Eminem/5.jpg" alt="Dragons" >
                      <i class="bi playListPlay bi-play-circle-fill" id="5"></i>
                  </div>
                  <h5>On My Way
                    <br>
